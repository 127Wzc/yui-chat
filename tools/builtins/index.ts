...
export const builtinToolGroups: BuiltinToolGroup[] = [
  { id: "command", label: "指令", risk: "low", tags: ["knowledge"], deferLoading: true, factory: createCommandTools },
  { id: "discovery", label: "工具发现", risk: "low", tags: ["tool-discovery"], deferLoading: false, factory: createDiscoveryTools },
  { id: "memory", label: "记忆", risk: "low", tags: ["memory"], deferLoading: true, factory: createMemoryTools },
  { id: "network", label: "网络检索", risk: "external", tags: ["web", "search"], deferLoading: true, policy: { externalNetwork: true }, factory: createNetworkTools },
  { id: "media", label: "媒体", risk: "medium", tags: ["message", "media"], deferLoading: true, factory: createMediaTools },
  { id: "render", label: "渲染", risk: "low", tags: ["image", "help"], deferLoading: true, factory: createRenderTools },
  { id: "social", label: "社交", risk: "medium", tags: ["message"], deferLoading: true, factory: createSocialTools },
...
export function createBuiltinTools(): NormalizedTool[] {
  return builtinToolGroups.flatMap(group => annotateTools(group.factory(), {
    ...
    risk: group.risk,
    tags: group.tags,
    deferLoading: group.deferLoading,
    policy: group.policy,
  }))
}
